...
@section('content')
    <style>
      ...
      box-shadow: 20px 20px 50px 10px rgba(83, 83, 83, 0.668) ;
        ...
        .gradient-custom-2 {
            background: url('https://th.bing.com/th/id/OIP.5DPgk4KFLyTlvSLDYdvbgQHaD_?pid=ImgDet&rs=1');
            object-fit: cover;
    ...
    <section class="gradient-form bg-white d-flex justify-content-center align-items-center" style="background-color: #eee;">
